        ...
        <div className="flex min-h-svh flex-col bg-background">
            ...
            <main className="mx-auto w-full max-w-5xl flex-1 px-4 py-8 md:py-12">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-12 max-w-md mx-auto">
                    <Link
                        href="/rulebook"
                        className="flex items-center justify-center rounded-lg border border-border bg-card px-4 py-3 text-sm font-semibold text-foreground transition-colors hover:bg-secondary"
                    >
                        Official Rulebook
                    </Link>
                    <Link
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
                    <Card>
                        <CardContent className="p-5 md:p-6">
                            <h2 className="text-base font-bold tracking-tight text-foreground mb-2">Fall Season</h2>
                    ...
                    <Card>
                        <CardContent className="p-5 md:p-6">
                            <h2 className="text-base font-bold tracking-tight text-foreground mb-2">Summer Season</h2>
                            <p className="text-sm text-muted-foreground leading-relaxed mb-5">
                ...
                <Card className="mb-10">
                    <CardContent className="p-5 md:p-6 flex flex-col md:flex-row gap-6 items-center md:items-start">
                        ...
                        <div>
                            <h2 className="text-base font-bold tracking-tight text-foreground mb-2">NBHL Competition</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <h2 className="text-base font-bold tracking-tight text-foreground mb-3">FAQ</h2>
                        <div className="space-y-3">
                            <Card>
                                <CardContent className="p-4">
                                    <h3 className="text-sm font-bold tracking-tight text-foreground mb-1.5">Do I need experience?</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                            ...
                            <Card>
                                <CardContent className="p-4">
                                    <h3 className="text-sm font-bold tracking-tight text-foreground mb-1.5">How to follow BASH?</h3>
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        Check out our{" "}
                    ...
                    <div>
                        <h2 className="text-base font-bold tracking-tight text-foreground mb-3">Equipment & Risk</h2>
                        <Card>
                            <CardContent className="p-4">
                                ...
                                <h4 className="text-sm font-bold tracking-tight text-primary mb-2">Recommended Gear</h4>
